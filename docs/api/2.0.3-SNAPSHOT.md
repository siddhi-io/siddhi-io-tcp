...
<table>
    ...
    <tr>
        ...
        <td style="vertical-align: top; word-wrap: break-word">Parameter 'context' can be optionally configured.</td>
    ...
    <tr>
        ...
        <td style="vertical-align: top; word-wrap: break-word">Number of threads to serve events.<br>System will pick the optimal value based on the number of processors available.</td>
        <td style="vertical-align: top">10</td>
        <td style="vertical-align: top">Any integer</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="vertical-align: top; word-wrap: break-word">This property is for the server.</td>
        <td style="vertical-align: top">true</td>
        <td style="vertical-align: top">true<br>false</td>
    </tr>
    <tr>
        <td style="vertical-align: top">keep.alive</td>
        <td style="vertical-align: top; word-wrap: break-word">This property defines whether the server should be kept alive or not when there are no connections available.</td>
        <td style="vertical-align: top">true</td>
        <td style="vertical-align: top">true<br>false</td>
    </tr>
</table>
...
```
<p style="word-wrap: break-word">Under this configuration, events are received via the TCP transport on default host,port and in the abc context and processes them in the Foo stream. </p>
...
<table>
    ...
    <tr>
        ...
        <td style="vertical-align: top; word-wrap: break-word">The URL to which outgoing events should be published via TCP.</td>
    ...
    <tr>
        ...
        <td style="vertical-align: top; word-wrap: break-word">This parameter defines whether the events should be published in a synchronized manner or not.</td>
